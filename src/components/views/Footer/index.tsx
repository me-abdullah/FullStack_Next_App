        ...
        <footer className="text-gray-500 body-font">
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2020 M Abdullah —
                        <a href="https://twitter.com/me_m_Abdullah" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">M Abdullah</a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        ...
                        <Link href={"https://github.com/me-abdullah"} className="w-5 h-5 ml-3 text-gray-500">
